...
class Init_SetLED_Request_led_n
{
public:
  Init_SetLED_Request_led_n()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetLED_Request_state led_n(::my_robot_interfaces::srv::SetLED_Request::_led_n_type arg)
  {
    msg_.led_n = std::move(arg);
...
{
  return my_robot_interfaces::srv::builder::Init_SetLED_Request_led_n();
}
