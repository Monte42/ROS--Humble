...
bool my_robot_interfaces__msg__new_turtle_pos__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_interfaces.msg._new_turtle_pos.NewTurtlePos", full_classname_dest, 52) == 0);
  }
  my_robot_interfaces__msg__NewTurtlePos * ros_message = _ros_message;
  {  // turtle_name
  ...
  {  // turtle_x
    ...
    ros_message->turtle_x = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // turtle_y
    ...
    assert(PyFloat_Check(field));
    ros_message->turtle_y = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // turtle_theta
    ...
    assert(PyFloat_Check(field));
    ros_message->turtle_theta = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of NewTurtlePos */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_interfaces.msg._new_turtle_pos");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NewTurtlePos");
