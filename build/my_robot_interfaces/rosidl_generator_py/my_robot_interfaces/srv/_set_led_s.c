...
bool my_robot_interfaces__srv__set_led__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // led_n
    PyObject * field = PyObject_GetAttrString(_pymsg, "led_n");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->led_n = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // state
...
PyObject * my_robot_interfaces__srv__set_led__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // led_n
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->led_n);
    {
      int rc = PyObject_SetAttrString(_pymessage, "led_n", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
