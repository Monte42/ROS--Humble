...
class SetLED_Request(metaclass=Metaclass_SetLED_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.led_n = kwargs.get('led_n', int())
    ...
    @led_n.setter
    def led_n(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'led_n' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'led_n' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._led_n = value
